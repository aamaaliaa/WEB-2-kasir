...
if(isset($_SESSION['login'])){
    // Sudah login, bisa lanjut ke halaman
                        ...
                        <tbody>
                            ...
                            <?php foreach ($barang as $brg) : ?>
                                <tr>
                                    ...
                                    <td><?= isset($brg['stock']) ? $brg['stock'] : 'N/A'; ?></td>
                                </tr>
                                <?php $i++; ?>
                            <?php endforeach; ?>
                        </tbody>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" name="deskripsi" class="form-control mt-3" placeholder="Deskripsi Produk" required>
                    <input type="number" name="harga" class="form-control mt-3" placeholder="Harga" required>
                    <input type="number" name="stock" class="form-control mt-3" placeholder="Stock" required>
                </div>
                <!-- Modal footer -->
