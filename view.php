...
if (isset($_GET['idp'])) {
    $idp = mysqli_real_escape_string($koneksi, $_GET['idp']);
                ...
                <div class="card mt-3 mb-4">
                    ...
                    <div class="card-body">
                        <table id="datatablesSimple">
                            ...
                            <tbody>
                            <?php
                            $getview = mysqli_query($koneksi, "SELECT * FROM detail_pesanan p, produk pr, pelanggan pl WHERE p.id_produk=pr.id_produk AND id_pesanan='$idp'AND id_pelanggan= '$idpel'");
                            $i = 1;
