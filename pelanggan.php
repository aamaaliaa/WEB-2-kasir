...
<body class="sb-nav-fixed">
                            ...
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $alamat; ?></td>
                                        <td>
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editpelanggan<?= $id_pelanggan; ?>">Edit</button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapuspelanggan<?= $id_pelanggan; ?>">Delete</button>
                                        </td>
                                    </tr>
                                     <!--- Modal Edit --->
                                     <div class="modal" id="editpelanggan<?= $id_pelanggan; ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <form method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <input type="text" name="nama_pelanggan" class="form-control mt-3"  value="<?= $pl['nama_pelanggan'] ?>">
                                                        <input type="text" name="notelp" class="form-control mt-3"  value="<?= $pl['notelp'] ?>">
                                                        <input type="text" name="alamat" class="form-control mt-3"  value="<?= $pl['alamat'] ?>">
                                                        <input type="hidden" name="id_pelanggan" class="form-control mt-3" value="<?= $id_pelanggan; ?>">
                                                    </div>
                                                    <!-- Modal footer -->
                                    ...
                                    <!--- Modal Hapus --->
                                    <div class="modal" id="hapuspelanggan<?= $id_pelanggan; ?>">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <!-- Modal Header -->
                                                <div class="modal-header">
    ...
    while ($pl = mysqli_fetch_assoc($pelanggan)) : ?>
    <div class="modal fade" id="deleteModal<?= htmlspecialchars($pl['id_pelanggan']); ?>" tabindex="-1" aria-labelledby="deleteModalLabel<?= htmlspecialchars($pl['id_pelanggan']); ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <!-- Modal Header -->
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteModalLabel<?= htmlspecialchars($pl['id_pelanggan']); ?>">Hapus Pelanggan</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" action="pelanggan.php">
                    <!-- Modal body -->
                    <div class="modal-body">
                        Apakah Anda yakin ingin menghapus pelanggan ini?
                        <input type="hidden" name="id_pelanggan" value="<?= htmlspecialchars($pl['id_pelanggan']); ?>">
                    </div>
                    <!-- Modal footer -->
                    <div class="modal-footer">
